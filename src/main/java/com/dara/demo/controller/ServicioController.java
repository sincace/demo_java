...
public class ServicioController {
	 ...
	 public CodigoBarra leeCodigoBarras(@RequestParam("imagenMultipartFile") MultipartFile imagenMultipartFile)  {
	        ...
	        try {
	           ...
	           CodigoBarra codigoBarra = new CodigoBarra("Error: ", "No se ha podido decodificar la imagen"+ e.getMessage());
	           return codigoBarra;
	...
	@PostMapping("/decode")
	 public CodigoBarra decodeCodigoBarras(@RequestParam("imagen") String imagenString)  {
        ...
        imageByte = decoder.decode(imagenString);
        ByteArrayInputStream imgInputStream = new ByteArrayInputStream(imageByte);
                    		
        try {
        	 //BufferedImage image = ImageIO.read(imgInputStream);
             codigoBarra = convierteImgCB.decodeCodigoBarras(imgInputStream);
             return codigoBarra;
